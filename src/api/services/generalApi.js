...
export const fetchUserApiToken = async (uid) => {
  ...
  try {
    ...
    const userResp = await axios.post(`${ODOO_BASE_URL}/web/dataset/call_kw`, readPayload, { headers: { 'Content-Type': 'application/json' } });
    ...
    const keyResp = await axios.post(`${ODOO_BASE_URL}/web/dataset/call_kw`, keyPayload, { headers: { 'Content-Type': 'application/json' } });
